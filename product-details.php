								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
                                            ...
                                            <span class="price-strike">$<?php if ($row['productPriceBeforeDiscount'] >= ($row['productPrice'])) echo htmlentities($row['productPriceBeforeDiscount']);
                                            else echo htmlentities($row['productPrice'])?></>
										</div>
									</div>
